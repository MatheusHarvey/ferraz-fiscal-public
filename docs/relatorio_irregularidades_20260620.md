...
**Fonte dos dados:** TCE-SP · Portal da Transparência Municipal · Receita Federal

---

## 1. Contexto

Este relatório foi gerado pelo Ferraz Fiscal, ferramenta local de auditoria cívica das finanças públicas de Ferraz de Vasconcelos. Os dados foram obtidos do Portal da Transparência Municipal do TCE-SP e cruzados com informações da Receita Federal.

---

## 2. Metodologia

Foram analisados contratos firmados por dispensa de licitação entre 2021 e 2024. Identificaram-se dois grupos de irregularidades: (1) fornecedores com múltiplos contratos no mesmo ano cujos valores somados ultrapassam o limite legal de R$ 50.000, configurando possível fracionamento ilegal; (2) locações de imóveis por dispensa com indícios de direcionamento a pessoas com vínculos familiares.

---

## 3. Visão Geral dos Achados

| Categoria | Contratos | Valor Total |
|---|---|---|
| Suspeitos de fracionamento | 10 casos | R$ 899,781.55 |
| Locações de imóveis suspeitas | 19 contratos | R$ 2,776,189.50 |
| **Total geral** | | **R$ 3,675,971.05** |

---

## 4. Fracionamento de Despesa

Os seguintes fornecedores receberam múltiplos contratos por dispensa no mesmo ano, com valores individuais abaixo do limite legal mas soma superior a R$ 50.000, caracterizando possível fracionamento vedado pelo Art. 20 da Lei 14.133/2021:

**Total envolvido: R$ 899,781.55 | 10 casos | concentrados em 2024**

### 4.1 Empresas com atividade incompatível

- **W & MACEDO ELÉTRICA LTDA** (CNPJ 29.179.763/0001-23) — CNAE: comércio varejista de material elétrico. Contratada para obras de engenharia. 4 contratos em 2024 — R$ 83.807,77.
- **CARLOS ALEXANDRO DE OLIVEIRA ARRUDA** (CNPJ 31.512.425/0001-03) — CNAE: transportes terrestres. Contratado para obras de construção. Registrado em São Paulo/SP. 2 contratos em 2024 — R$ 64.467,45.

### 4.2 Empresa recém-criada contratada imediatamente

**JA RODRIGUES ARQUITETURA E ENGENHARIA LTDA** (CNPJ 55.871.049/0001-01) — aberta em 10/07/2024 e já contratada no mesmo ano. 2 contratos — R$ 69.940,89. Registrada em Suzano/SP.

### 4.3 Empresa inapta

**TEC CONST EMPREENDIMENTOS** (CNPJ 03.866.882/0001-60) — inapta desde 12/05/2026. Contratos firmados em 2022. Recomenda-se verificar situação fiscal à época da contratação.

### 4.4 Tabela completa de casos suspeitos

| Empresa | Município | Situação | Ano | Contratos | Valor Total |
|---|---|---|---|---|---|
| BERTY CONSTRUCOES LTDA EPP | nan/nan | nan | 2024 | 7x | R$ 150,227.40 |
| RT LOCACOES DE MAQUINAS E EQUIPAMENTOS LTDA | nan/nan | nan | 2024 | 3x | R$ 109,850.84 |
| E DE SOUZA LOPES | nan/nan | nan | 2024 | 4x | R$ 102,149.49 |
| THREE F ENGENHARIA E CONSULTORIA EIRELI | nan/nan | nan | 2024 | 5x | R$ 93,250.12 |
| DRA LTDA | nan/nan | nan | 2024 | 3x | R$ 86,150.84 |
| W & MACEDO ELETRICA EIRELI | nan/nan | nan | 2024 | 4x | R$ 83,807.77 |
| FABIO BRETAS MAIA | nan/nan | nan | 2024 | 3x | R$ 74,120.74 |
| JA RODRIGUES ARQUITETURA E ENGENHARIA LTDA | nan/nan | nan | 2024 | 2x | R$ 69,940.89 |
| TEC-CONST EMPEENDIMENTOS COM.PARTIC.LTDA | nan/nan | nan | 2022 | 2x | R$ 65,816.01 |
| CARLOS ALEXANDRO DE O. ARRUDA CONSTRUCOES | nan/nan | nan | 2024 | 2x | R$ 64,467.45 |

---

## 5. Locações de Imóveis por Dispensa

Foram identificadas **19 locações de imóveis** por dispensa de licitação totalizando **R$ 2,776,189.50**. Do total, 87% dos contratos (R$ 1,951,606.50) foram firmados com **pessoas físicas**, sem processo licitatório formal.

### 5.1 Possíveis vínculos familiares

Os seguintes pares de contratados compartilham sobrenome e tiveram contratos firmados na mesma data com valores idênticos ou próximos, sugerindo possível direcionamento a pessoas com vínculos familiares:
...
### 5.2 Maiores contratos de locação com custo mensal

| Contratado | Valor Total | Vigência | Custo Mensal |
|---|---|---|---|
| INDUSTRIA E COMERCIO DE ALUMINIO ABC LTDA | R$ 464,583.00 | nan a nan | s/d |
| LATUF CURY PARTICIPACOES S.A | R$ 360,000.00 | 17/06/2021 a 17/12/2023 | R$ 12,000.00/mês |
| ROSA MARIA PINHEIRO ABISSAMRA | R$ 234,000.00 | 03/06/2022 a 03/12/2024 | R$ 7,800.00/mês |
| BRAULIO BUENO DE ALMEIDA | R$ 225,000.00 | 19/04/2021 a 19/10/2023 | R$ 7,500.00/mês |
| SILVANA VALIERIS BUENO DE ALMEIDA | R$ 225,000.00 | 19/04/2021 a 19/10/2023 | R$ 7,500.00/mês |

> **Nota:** A INDÚSTRIA E COMÉRCIO DE ALUMÍNIO ABC LTDA recebeu o maior contrato de locação (R$ 464.583,00) sem datas de vigência registradas, o que dificulta a verificação da regularidade do contrato.

### 5.3 Todos os contratos de locação

| Contratado | Valor Total | Meses | Custo Mensal |
|---|---|---|---|
| INDUSTRIA E COMERCIO DE ALUMINIO ABC LTDA | R$ 464,583.00 | s/d | s/d |
| LATUF CURY PARTICIPACOES S.A | R$ 360,000.00 | 30 | R$ 12,000.00/mês |
| ROSA MARIA PINHEIRO ABISSAMRA | R$ 234,000.00 | 30 | R$ 7,800.00/mês |
| BRAULIO BUENO DE ALMEIDA | R$ 225,000.00 | 30 | R$ 7,500.00/mês |
| ELIZABETE CORREIA SARMENTO | R$ 225,000.00 | 30 | R$ 7,500.00/mês |
| SILVANA VALIERIS BUENO DE ALMEIDA | R$ 225,000.00 | 30 | R$ 7,500.00/mês |
| EUDAS DE CARVALHO | R$ 210,000.00 | 30 | R$ 7,000.00/mês |
| LUCIANO ANDRE DA SILVA | R$ 147,666.60 | 30 | R$ 4,922.22/mês |
| ARNALDO DA SILVA ALVES | R$ 135,000.00 | 30 | R$ 4,500.00/mês |
| REGINA CLAUDINA DA CUNHA CHAGAS | R$ 111,007.95 | 30 | R$ 3,700.26/mês |
| SILVIO FRANCISCO CHAGAS | R$ 111,007.95 | 30 | R$ 3,700.26/mês |
| MARIA LUIZA BASTOS DOS SANTOS | R$ 102,000.00 | 30 | R$ 3,400.00/mês |
| JOAQUIM APARECIDO DE ATAIDE SILVA SANTOS | R$ 64,500.00 | 30 | R$ 2,150.00/mês |
| MARILIA MARTINELLI LOPES RODRIGUES | R$ 48,000.00 | 12 | R$ 4,000.00/mês |
| FRANCISCO BARBOSA DE LUNA | R$ 27,000.00 | 30 | R$ 900.00/mês |
| VILMA AMERICO | R$ 22,200.00 | 12 | R$ 1,850.00/mês |
| GILENO PEREIRA | R$ 22,200.00 | 12 | R$ 1,850.00/mês |
| JOSE CARLOS PEREIRA | R$ 21,012.00 | 12 | R$ 1,751.00/mês |
| MARIA RITA MASCHIETTO PEREIRA | R$ 21,012.00 | 12 | R$ 1,751.00/mês |

---

## 6. Recomendações

1. **Solicitar via LAI** os processos administrativos de todas as dispensas identificadas, especialmente as locações, verificando avaliações de valor de mercado e justificativas formais.
2. **Investigar vínculos** entre os pares ALMEIDA e CHAGAS e agentes públicos da administração municipal no período das contratações.
3. **Verificar habilitação** de W & MACEDO e CARLOS ALEXANDRO nos processos de 2024 — atividade declarada é incompatível com obras de engenharia.
4. **Apurar fracionamento** em BERTY CONSTRUÇÕES (7 contratos, R$ 150k) e THREE F ENGENHARIA (5 contratos, R$ 93k).
5. **Encaminhar ao TCE-SP** denúncia formal: https://www.tce.sp.gov.br/fale-conosco

---

## 7. Achados sem irregularidade

### 7.1 Dispensas de medicamentos — gestão adequada

A análise das 607 dispensas de medicamentos identificadas entre 2020 e 2024 não revelou indícios de irregularidade. O volume elevado em 2024 (+972% em relação à média histórica) decorreu da consolidação de compras em poucos processos: 208 itens em 2 processos em março e 206 itens em 1 processo em dezembro. Padrão compatível com reposição semestral de estoque da farmácia municipal. **Avaliação: ponto positivo da gestão atual.**

---

## 8. Próximas investigações

- Monitoramento de **gastos com pessoal** (crescimento de 5pp em 2022–2023)
- Monitoramento de **gastos com saúde** (próximo do mínimo de 15%)
- Integração dos dados de **convênios federais** ao relatório
- Incorporação dos achados ao **dashboard Streamlit**
...
|---|---|
| Emenda Individual - Transferências com Finalidade Definida | R$ 18,311,312.00 |
| Emenda Individual - Transferências Especiais | R$ 18,135,078.00 |
| Emenda de Comissão | R$ 17,590,657.00 |
| Emenda de Relator | R$ 4,568,807.88 |
...
| COM. DA SAUDE | R$ 10,323,623.00 |
| COM. DESENV REGIONAL E TURISMO | R$ 5,743,773.00 |
| ALENCAR SANTANA | R$ 5,000,000.00 |
| RELATOR GERAL | R$ 4,568,807.88 |
| ABOU ANNI | R$ 4,000,254.00 |
| ELI CORREA FILHO | R$ 3,258,418.00 |
| MILTON VIEIRA | R$ 2,500,000.00 |
| FAUSTO PINATO | R$ 1,800,000.00 |
| MAJOR OLIMPIO | R$ 1,200,000.00 |
...
|---|---|
| FUNDO MUNICIPAL DE SAUDE | R$ 30,123,685.00 |
| MUNICIPIO DE FERRAZ DE VASCONCELOS | R$ 27,970,919.88 |
| FUNDO MUNICIPAL DE ASSISTENCIA SOCIAL | R$ 500,000.00 |
| CAIXA ECONOMICA FEDERAL | R$ 11,250.00 |
...
1. **Contrato 329/2022** — 4 anos via aditivos, acúmulo de R$ 15,624,368.83
2. **Contrato 189/2021** — 5 anos via aditivos, acúmulo de R$ 5,892,475.77
